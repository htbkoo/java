...
class DynamicArrayTest extends Specification {
    ...
    def "should append new number to seqList"() {
        ...
        where:
        n   || queries    || expected
        2   || queries0() || expected0()
        100 || queries1() || expected1()
    }
    ...
    def expected1() {
        [855677723, 75865401, 763845832, 75865401, 709571211, 645102173, 112869154, 763845832, 449768243, 757848208, 91038209, 205970905, 783321829, 372160176, 384358662, 67467208, 935143105, 384358662, 309720694, 138234911]
    }
}
