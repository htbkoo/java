...
public class FindMinimumInRotatedSortedArrayIITest {
    ...
    public static Collection<Pair<Integer[], Integer>[]> data() {
        ...
        return Arrays.<Pair<Integer[], Integer>[]>asList(
                new Pair[]{
                        ...
                        new ImmutablePair<>
                                (new Integer[]{3,3,3,3,3,3}, 3)
                }, new Pair[]{
                        new ImmutablePair<>
                                (new Integer[]{3,3,3,3,1,3}, 1)
                });
    }
    ...
    public FindMinimumInRotatedSortedArrayIITest(Pair<Integer[], Integer> inputExpectedPair) {
//        This method may be nasty and it should be improved
    ...
    public void shouldFindMin() {
        assertEquals(fExpected, new FindMinimumInRotatedSortedArrayII().findMin(fInput));
    }
}