 ...
 * ---
 * <p>
 * http://www.codewars.com/kata/magnet-particules-in-boxes/train/java
 */
...
Notes:
    ...
    Don't truncate or round: the tests will pass if abs(your_result - test_result) <= 1e-6 Have a look in "Run" at "assertFuzzyEqual".
...
public class MagnetParticulesInBoxes {
    public static class Magnets {
        ...
        private static double getV(int k, int n) {
            return 1d / (k * Math.pow(n + 1, 2 * k));
        }
    }
}
